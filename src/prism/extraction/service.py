...
class ExtractionService:
    ...
    def _evolution_prompt(
        ...
        return (
            ...
            "observed_at must be on or after valid_at, and observed_at must not be "
            "earlier than happened_at or stated_at when those timestamps apply. The "
            "material publication time is not the event time. Every timestamp "
